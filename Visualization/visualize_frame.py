...
human_model = smplx.create(
    ...
    use_pca=True, num_pca_comps=24, flat_hand_mean=True, batch_size=1 # Batch size 1
)
...
right_hand_pose_t = torch.tensor(body_data['right_hand_pose'][TARGET_FRAME_IDX : TARGET_FRAME_IDX+1], dtype=torch.float32)
...
static_scene.set_camera(distance=0.5, center=current_obj_transl)
